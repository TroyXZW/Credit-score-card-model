...
# 一.数据集生成
print('--------------------数据生成--------------------\n')
dataset = pd.read_csv(r'E:\PycharmProjects\sklearn\Data\风控\LoanStats_2017Q1.csv', encoding='utf-8', skiprows=1, usecols=basic_features)
for i in range(1, 5):  # 将2017年的数据集进行合并
    data = pd.read_csv(r'E:\PycharmProjects\sklearn\Data\风控\LoanStats_2017Q{}.csv'.format(i), encoding='utf-8', skiprows=1, usecols=basic_features)
